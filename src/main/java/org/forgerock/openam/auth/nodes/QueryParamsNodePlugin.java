 ...
 */
public class QueryParamsNodePlugin extends AbstractNodeAmPlugin {
     ...
     */
    @Inject
    public QueryParamsNodePlugin(AnnotatedServiceRegistry serviceRegistry) {
    ...
    protected Iterable<? extends Class<? extends Node>> getNodes() {
        return asList(
                QueryParamsNode.class
        );
    }

    @Override
    public void upgrade(String fromVersion) throws PluginException {
        pluginTools.upgradeAuthNode(QueryParamsNode.class);
